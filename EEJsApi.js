...
c.checkLayer = {};
c.checkLayer.headerLabel = ui.Label('Select parameters');
  // info panel
...
// Select your area of interest
  // Draw a shape
c.drawTool = {};
c.drawTool.headerLabel = ui.Label('Select area of interest');
  // info panel
...
c.inputCoords.northTextbox = ui.Textbox({
  ...
  style: {width: '113px', margin: '0px 0px 8px 15px'}
});
c.inputCoords.eastTextbox = ui.Textbox({
  ...
  style: {width: '113px', margin: '0px 15px 8px 10px'}
});
...
c.inputCoords.westLabel = ui.Textbox({
  ...
  style: {width: '113px', margin: '0px 0px 8px 10px'}
});
